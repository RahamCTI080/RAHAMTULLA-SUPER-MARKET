...
class Bill_App:
    def __init__(self,root):
        ...
        self.root.title("RAHAMTULLA SUPER MARKET")
        title=Label(self.root,text="RAHAMTULLA SUPER MARKET",bd=12,relief=RIDGE,font=("Arial Black",20),bg="#A569BD",fg="white").pack(fill=X)
        #===================================variables=======================================================================================
        self.nutella=IntVar()
        self.noodles=IntVar()
        self.lays=IntVar()
